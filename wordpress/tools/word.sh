...
wp core install --url=https://10.13.100.232/ --title='Example' --admin_user=supervisor --admin_password=strongpassword --admin_email=info@example.com --path=/var/www/html/wordpress --allow-root 
